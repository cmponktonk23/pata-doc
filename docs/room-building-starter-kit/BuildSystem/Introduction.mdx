...
be setup automatically during package installation.

:::note
This is an entire project, when import 
this package you will see a warning popup window told you import this package will overwrite your 
current project settings. 
`Please make sure you did backup if you need to import this package to your 
existing project!`
:::
...
### Dependencies
This project need `post-process` package for the visual effect and `newtonsoft.json` package for 
...
the layers list in below picture are added correctly.
...
Wizard”` as below picture. Don’t worry about the errors displayed on the wizard window. 
