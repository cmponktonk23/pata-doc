...
**Room Building Starter Kit Pro** includes the `BuildSystem-Only` version [Room Building Starter Kit](https://patastudio.store/assets/0656caba-f65f-4dbd-8477-3c032c5297d8). You can install it by `Install BuildSystem Only` package. *Remove other files before do this.*
